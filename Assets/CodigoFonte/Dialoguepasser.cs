...
public class Dialoguepasser : MonoBehaviour
{
    ...
    struct DialogueLine
    { //Cria a estrutura para passar os dialogos;
        ...
        { //cria uma função para pegar dados que se encaixam nesta extrutura;
            name = Name;
            content = Content;
            pose = Pose;
            position = Position;
    ...
    void Start()
    { //Relaciona o arquivo do dialogo a cena, (enumerar as cenas para facilitar) 
    ...
    public string[] GetOptions(int lineNumber)
    {
        ...
        return new string[0]; //pega as opções das escolhas do player
    }
}
